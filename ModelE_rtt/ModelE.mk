# File name: ModelE.mk
# Autogenerated on: 17-May-2016 16:28:40
...
SOURCE_FILES        := $(call FORMAT_PATH,.\linuxUDP.c) $(call FORMAT_PATH,.\ModelE.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\rtGetInf.c) $(call FORMAT_PATH,.\rtGetNaN.c) $(call FORMAT_PATH,.\rt_nonfinite.c) $(call FORMAT_PATH,.\rt_zcfcn.c)
HEADER_FILES        := $(call FORMAT_PATH,.\ModelE.h) $(call FORMAT_PATH,.\rtGetInf.h) $(call FORMAT_PATH,.\rtGetNaN.h) $(call FORMAT_PATH,.\rt_nonfinite.h) $(call FORMAT_PATH,.\rt_zcfcn.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"C:/Users/admin/Documents/MATLAB/ModelE_rtt" -I"C:/Users/admin/Documents/MATLAB" -I"C:/Program Files/MATLAB/R2014a/extern/include" -I"C:/Program Files/MATLAB/R2014a/simulink/include" -I"C:/Program Files/MATLAB/R2014a/rtw/c/src" -I"C:/Program Files/MATLAB/R2014a/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2014a/rtw/c/ert" -I"C:/Program Files/MATLAB/R2014a/toolbox/shared/dspblks/extern/include" -O3 -D"MODEL=ModelE" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=0" -D"_USE_TARGET_UDP_=" -D"_RUNONTARGETHARDWARE_BUILD_="
