...
## 
## Makefile     : test.mk
## Generated on : Sun Apr 17 22:43:41 2016
...
INCLUDES_BUILDINFO = $(START_DIR)\test_grt_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\test_grt_rtw\rtGetInf.c $(START_DIR)\test_grt_rtw\rtGetNaN.c $(START_DIR)\test_grt_rtw\rt_nonfinite.c $(START_DIR)\test_grt_rtw\test.c $(START_DIR)\test_grt_rtw\test_data.c rt_logging.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj test.obj test_data.obj rt_logging.obj
