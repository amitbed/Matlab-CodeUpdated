...
static void mw__internal__start___fcn(InstanceStruct_jGJeUnXowSnrBTmm3TGSwB
  *moduleInstance);
static void mw__internal__initialize__fcn(InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *
  moduleInstance);
static void mw__internal__outputs__fcn(InstanceStruct_jGJeUnXowSnrBTmm3TGSwB
  *moduleInstance);
static void mw__internal__update__fcn(InstanceStruct_jGJeUnXowSnrBTmm3TGSwB
  *moduleInstance);
static void mw__internal__terminate__fcn(InstanceStruct_jGJeUnXowSnrBTmm3TGSwB
  *moduleInstance);
...
static const mxArray *mw__internal__getSimState__fcn
  (InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *moduleInstance);
...
static boolean_T d_emlrt_marshallIn(const mxArray *b_sysobj_not_empty, const
  char_T *identifier);
static void mw__internal__setSimState__fcn(InstanceStruct_jGJeUnXowSnrBTmm3TGSwB
...
static const mxArray *mw__internal__autoInference__fcn(void)
{
  ...
  static char_T cv25[21] = { 'P', 'v', 'F', '3', 'X', 'E', 'R', 'X', 'K', 'P',
    'o', '2', 'Z', 'N', 'G', 't', 'D', 'b', '6', 'f', 'F' };
  ...
  static uint32_T uv0[4] = { 422767618U, 2039901938U, 2881736823U, 2235349202U };
  ...
  static uint32_T t5_chksum[4] = { 2283046609U, 2279527514U, 848423204U,
    1318134283U };
...
/* CGXE Glue Code */
static void mdlOutputs_jGJeUnXowSnrBTmm3TGSwB(SimStruct *S, int_T tid)
{
  InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *moduleInstance;
  moduleInstance = (InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
  mw__internal__outputs__fcn(moduleInstance);
  CGXERT_LEAVE_CHECK();
}

static void mdlInitialize_jGJeUnXowSnrBTmm3TGSwB(SimStruct *S)
{
  InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *moduleInstance;
  moduleInstance = (InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static void mdlUpdate_jGJeUnXowSnrBTmm3TGSwB(SimStruct *S, int_T tid)
{
  InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *moduleInstance;
  moduleInstance = (InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static mxArray* getSimState_jGJeUnXowSnrBTmm3TGSwB(SimStruct *S)
{
  InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *moduleInstance;
  mxArray* mxSS;
  moduleInstance = (InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *)ssGetUserData(S);
...
static void setSimState_jGJeUnXowSnrBTmm3TGSwB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *moduleInstance;
  moduleInstance = (InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static void mdlTerminate_jGJeUnXowSnrBTmm3TGSwB(SimStruct *S)
{
  InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *moduleInstance;
  moduleInstance = (InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static void mdlStart_jGJeUnXowSnrBTmm3TGSwB(SimStruct *S)
{
  InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *moduleInstance;
  moduleInstance = (InstanceStruct_jGJeUnXowSnrBTmm3TGSwB *)calloc(1, sizeof
    (InstanceStruct_jGJeUnXowSnrBTmm3TGSwB));
  moduleInstance->S = S;
  ...
  ssSetmdlOutputs(S, mdlOutputs_jGJeUnXowSnrBTmm3TGSwB);
  ssSetmdlInitializeConditions(S, mdlInitialize_jGJeUnXowSnrBTmm3TGSwB);
  ssSetmdlUpdate(S, mdlUpdate_jGJeUnXowSnrBTmm3TGSwB);
  ssSetmdlTerminate(S, mdlTerminate_jGJeUnXowSnrBTmm3TGSwB);
}

static void mdlProcessParameters_jGJeUnXowSnrBTmm3TGSwB(SimStruct *S)
{
}

void method_dispatcher_jGJeUnXowSnrBTmm3TGSwB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_jGJeUnXowSnrBTmm3TGSwB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_jGJeUnXowSnrBTmm3TGSwB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_jGJeUnXowSnrBTmm3TGSwB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_jGJeUnXowSnrBTmm3TGSwB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: jGJeUnXowSnrBTmm3TGSwB.\n"
...
int autoInfer_dispatcher_jGJeUnXowSnrBTmm3TGSwB(mxArray* plhs[], const char
  * commandName)
{
...
mxArray *cgxe_jGJeUnXowSnrBTmm3TGSwB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
