#ifndef __ModelD_cgxe_h__
#define __ModelD_cgxe_h__
...
extern unsigned int cgxe_ModelD_method_dispatcher(SimStruct* S, int_T method,
  void* data);
extern int cgxe_ModelD_autoInfer_dispatcher(const mxArray* prhs, mxArray* lhs[],
  const char* commandName);
extern void cgxe_ModelD_initializer(void);
extern void cgxe_ModelD_terminator(void);
