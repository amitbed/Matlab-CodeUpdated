...
static void mw__internal__start___fcn(InstanceStruct_t0r9JzKNkkWY1vKyCq46gE
  *moduleInstance);
static void mw__internal__initialize__fcn(InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *
  moduleInstance);
static void mw__internal__outputs__fcn(InstanceStruct_t0r9JzKNkkWY1vKyCq46gE
  *moduleInstance);
static void mw__internal__update__fcn(InstanceStruct_t0r9JzKNkkWY1vKyCq46gE
  *moduleInstance);
static void mw__internal__terminate__fcn(InstanceStruct_t0r9JzKNkkWY1vKyCq46gE
  *moduleInstance);
...
static const mxArray *mw__internal__getSimState__fcn
  (InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *moduleInstance);
...
static boolean_T d_emlrt_marshallIn(const mxArray *b_sysobj_not_empty, const
  char_T *identifier);
static void mw__internal__setSimState__fcn(InstanceStruct_t0r9JzKNkkWY1vKyCq46gE
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1460547704U), "fileTimeLo", 31);
...
static const mxArray *mw__internal__autoInference__fcn(void)
{
  ...
  char_T t1_objTypeName[10];
  int32_T i4;
  static char_T cv24[10] = { 'M', 'a', 'v', 'l', 'i', 'n', 'k', 'M', 's', 'g' };

  char_T t1_sysObjChksum[21];
  static char_T cv25[21] = { 'c', 'x', 'h', 'V', 'K', 'K', 'O', 'o', 'L', 'O',
    'Y', 'U', 'Q', 'r', 'S', 'f', 'B', 'X', 'h', 'k', 'p' };
  ...
  static uint32_T uv0[4] = { 3293317654U, 1965091921U, 2437599121U, 3060787271U
  };

  static uint32_T t2_chksum[4] = { 2929187129U, 2983884651U, 1824242399U,
    981001456U };

  static int32_T t3_chksum[4] = { 725019261, 9350207, 1380543125, 1962202275 };

  static uint32_T t4_chksum[4] = { 2231358449U, 846670147U, 502410630U,
    1651697092U };

  static int32_T t5_chksum[4] = { 1587758272, 1911759394, 44796038, 2140838827 };
  ...
  infoCache = NULL;
  for (i4 = 0; i4 < 10; i4++) {
    t1_objTypeName[i4] = cv24[i4];
  }

  for (i4 = 0; i4 < 21; i4++) {
    t1_sysObjChksum[i4] = cv25[i4];
  }

  for (i4 = 0; i4 < 4; i4++) {
    t0_cgxeChksum[i4] = uv0[i4];
    expl_temp.chksum[i4] = (real_T)t2_chksum[i4];
    b_expl_temp.chksum[i4] = (real_T)t3_chksum[i4];
    c_expl_temp.chksum[i4] = (real_T)t4_chksum[i4];
    d_expl_temp.chksum[i4] = (real_T)t5_chksum[i4];
  }
  ...
  emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 10, m6, t1_objTypeName);
  emlrtAssign(&f_y, m6);
  ...
  emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 21, m6, t1_sysObjChksum);
  emlrtAssign(&i_y, m6);
  ...
  n_y = NULL;
  m6 = emlrtCreateDoubleScalar(6.0);
  emlrtAssign(&n_y, m6);
...
/* CGXE Glue Code */
static void mdlOutputs_t0r9JzKNkkWY1vKyCq46gE(SimStruct *S, int_T tid)
{
  InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *moduleInstance;
  moduleInstance = (InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
  mw__internal__outputs__fcn(moduleInstance);
  CGXERT_LEAVE_CHECK();
}

static void mdlInitialize_t0r9JzKNkkWY1vKyCq46gE(SimStruct *S)
{
  InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *moduleInstance;
  moduleInstance = (InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static void mdlUpdate_t0r9JzKNkkWY1vKyCq46gE(SimStruct *S, int_T tid)
{
  InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *moduleInstance;
  moduleInstance = (InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static mxArray* getSimState_t0r9JzKNkkWY1vKyCq46gE(SimStruct *S)
{
  InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *moduleInstance;
  mxArray* mxSS;
  moduleInstance = (InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *)ssGetUserData(S);
...
static void setSimState_t0r9JzKNkkWY1vKyCq46gE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *moduleInstance;
  moduleInstance = (InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static void mdlTerminate_t0r9JzKNkkWY1vKyCq46gE(SimStruct *S)
{
  InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *moduleInstance;
  moduleInstance = (InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static void mdlStart_t0r9JzKNkkWY1vKyCq46gE(SimStruct *S)
{
  InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *moduleInstance;
  moduleInstance = (InstanceStruct_t0r9JzKNkkWY1vKyCq46gE *)calloc(1, sizeof
    (InstanceStruct_t0r9JzKNkkWY1vKyCq46gE));
  moduleInstance->S = S;
  ...
  ssSetmdlOutputs(S, mdlOutputs_t0r9JzKNkkWY1vKyCq46gE);
  ssSetmdlInitializeConditions(S, mdlInitialize_t0r9JzKNkkWY1vKyCq46gE);
  ssSetmdlUpdate(S, mdlUpdate_t0r9JzKNkkWY1vKyCq46gE);
  ssSetmdlTerminate(S, mdlTerminate_t0r9JzKNkkWY1vKyCq46gE);
}

static void mdlProcessParameters_t0r9JzKNkkWY1vKyCq46gE(SimStruct *S)
{
}

void method_dispatcher_t0r9JzKNkkWY1vKyCq46gE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_t0r9JzKNkkWY1vKyCq46gE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_t0r9JzKNkkWY1vKyCq46gE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_t0r9JzKNkkWY1vKyCq46gE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_t0r9JzKNkkWY1vKyCq46gE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: t0r9JzKNkkWY1vKyCq46gE.\n"
...
int autoInfer_dispatcher_t0r9JzKNkkWY1vKyCq46gE(mxArray* plhs[], const char
  * commandName)
{
...
mxArray *cgxe_t0r9JzKNkkWY1vKyCq46gE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
