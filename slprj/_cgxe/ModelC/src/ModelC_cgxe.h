#ifndef __ModelC_cgxe_h__
#define __ModelC_cgxe_h__
...
extern unsigned int cgxe_ModelC_method_dispatcher(SimStruct* S, int_T method,
  void* data);
extern int cgxe_ModelC_autoInfer_dispatcher(const mxArray* prhs, mxArray* lhs[],
  const char* commandName);
extern void cgxe_ModelC_initializer(void);
extern void cgxe_ModelC_terminator(void);
