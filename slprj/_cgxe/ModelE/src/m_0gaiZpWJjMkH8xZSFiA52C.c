...
static void mw__internal__start___fcn(InstanceStruct_0gaiZpWJjMkH8xZSFiA52C
  *moduleInstance);
static void mw__internal__initialize__fcn(InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *
  moduleInstance);
static void mw__internal__outputs__fcn(InstanceStruct_0gaiZpWJjMkH8xZSFiA52C
  *moduleInstance);
static void mw__internal__update__fcn(InstanceStruct_0gaiZpWJjMkH8xZSFiA52C
  *moduleInstance);
static void mw__internal__terminate__fcn(InstanceStruct_0gaiZpWJjMkH8xZSFiA52C
  *moduleInstance);
...
static const mxArray *mw__internal__getSimState__fcn
  (InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *moduleInstance);
...
static boolean_T d_emlrt_marshallIn(const mxArray *b_sysobj_not_empty, const
  char_T *identifier);
static void mw__internal__setSimState__fcn(InstanceStruct_0gaiZpWJjMkH8xZSFiA52C
...
static const mxArray *mw__internal__autoInference__fcn(void)
{
  ...
  static char_T cv25[22] = { 'N', 'o', 'm', 'l', '2', 't', 'c', 'o', 'u', 'Y',
    'X', 'y', 'C', '2', 'p', 'A', 'O', 'Y', 'O', 'U', 'j', 'F' };
  ...
  static uint32_T uv0[4] = { 1801716151U, 290947059U, 119550427U, 3722973390U };
  ...
  static uint32_T t5_chksum[4] = { 1211499378U, 2404936389U, 3409595046U,
    2787665283U };
...
/* CGXE Glue Code */
static void mdlOutputs_0gaiZpWJjMkH8xZSFiA52C(SimStruct *S, int_T tid)
{
  InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *moduleInstance;
  moduleInstance = (InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
  mw__internal__outputs__fcn(moduleInstance);
  CGXERT_LEAVE_CHECK();
}

static void mdlInitialize_0gaiZpWJjMkH8xZSFiA52C(SimStruct *S)
{
  InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *moduleInstance;
  moduleInstance = (InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static void mdlUpdate_0gaiZpWJjMkH8xZSFiA52C(SimStruct *S, int_T tid)
{
  InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *moduleInstance;
  moduleInstance = (InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static mxArray* getSimState_0gaiZpWJjMkH8xZSFiA52C(SimStruct *S)
{
  InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *moduleInstance;
  mxArray* mxSS;
  moduleInstance = (InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *)ssGetUserData(S);
...
static void setSimState_0gaiZpWJjMkH8xZSFiA52C(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *moduleInstance;
  moduleInstance = (InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static void mdlTerminate_0gaiZpWJjMkH8xZSFiA52C(SimStruct *S)
{
  InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *moduleInstance;
  moduleInstance = (InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *)ssGetUserData(S);
  CGXERT_ENTER_CHECK();
...
static void mdlStart_0gaiZpWJjMkH8xZSFiA52C(SimStruct *S)
{
  InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *moduleInstance;
  moduleInstance = (InstanceStruct_0gaiZpWJjMkH8xZSFiA52C *)calloc(1, sizeof
    (InstanceStruct_0gaiZpWJjMkH8xZSFiA52C));
  moduleInstance->S = S;
  ...
  ssSetmdlOutputs(S, mdlOutputs_0gaiZpWJjMkH8xZSFiA52C);
  ssSetmdlInitializeConditions(S, mdlInitialize_0gaiZpWJjMkH8xZSFiA52C);
  ssSetmdlUpdate(S, mdlUpdate_0gaiZpWJjMkH8xZSFiA52C);
  ssSetmdlTerminate(S, mdlTerminate_0gaiZpWJjMkH8xZSFiA52C);
}

static void mdlProcessParameters_0gaiZpWJjMkH8xZSFiA52C(SimStruct *S)
{
}

void method_dispatcher_0gaiZpWJjMkH8xZSFiA52C(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_0gaiZpWJjMkH8xZSFiA52C(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_0gaiZpWJjMkH8xZSFiA52C(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_0gaiZpWJjMkH8xZSFiA52C(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_0gaiZpWJjMkH8xZSFiA52C(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 0gaiZpWJjMkH8xZSFiA52C.\n"
...
int autoInfer_dispatcher_0gaiZpWJjMkH8xZSFiA52C(mxArray* plhs[], const char
  * commandName)
{
...
mxArray *cgxe_0gaiZpWJjMkH8xZSFiA52C_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
