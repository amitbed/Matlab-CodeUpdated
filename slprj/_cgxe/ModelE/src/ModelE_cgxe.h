#ifndef __ModelE_cgxe_h__
#define __ModelE_cgxe_h__
...
extern unsigned int cgxe_ModelE_method_dispatcher(SimStruct* S, int_T method,
  void* data);
extern int cgxe_ModelE_autoInfer_dispatcher(const mxArray* prhs, mxArray* lhs[],
  const char* commandName);
extern void cgxe_ModelE_initializer(void);
extern void cgxe_ModelE_terminator(void);
