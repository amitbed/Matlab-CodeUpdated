# File name: testA.mk
# Autogenerated on: 21-Mar-2016 23:02:36
...
SOURCE_FILES        := $(call FORMAT_PATH,.\linuxUDP.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\testA.c) $(call FORMAT_PATH,.\testA_data.c)
HEADER_FILES        := $(call FORMAT_PATH,.\testA.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"C:/Users/admin/Documents/MATLAB/testA_rtt" -I"C:/Users/admin/Documents/MATLAB" -I"C:/Program Files/MATLAB/R2014a/extern/include" -I"C:/Program Files/MATLAB/R2014a/simulink/include" -I"C:/Program Files/MATLAB/R2014a/rtw/c/src" -I"C:/Program Files/MATLAB/R2014a/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2014a/rtw/c/ert" -I"C:/Program Files/MATLAB/R2014a/toolbox/shared/dspblks/extern/include" -O3 -D"MODEL=testA" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=0" -D"_USE_TARGET_UDP_=" -D"_RUNONTARGETHARDWARE_BUILD_="
